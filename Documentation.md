...
- [DiscordUtility.defaultEmbed()](#discordutilitydefaultEmbed)
...
#### DiscordUtility.defaultEmbed()

| Parameter | Type | Description |
| --- | --- | --- |
| options | Object | Default options for embeds in Discordutility.generateEmbed() OR DiscordUtility.createEmbedPages() (check them below) |

##### Example

```js
DiscordUtility.defaultEmbed({
    watermark: "[Support Server](link) | [Invite Me](link)",
    footer: client.user.username,
    footerImage: client.user.displayAvatarURL(),
    author: client.user.username,
    authorImage: client.user.displayAvatarURL()
    header: "Make Sure to Invite me!\n\n" //Add "\n\n" to give 2 lines gap between the header and the main description of the embed.
    color: "#0000ff",
